 ...
 * @author Cassandra
 */
public class VtnRegHisPer extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        setTitle("Registro de Historial Clínico de Personal");
        setResizable(false);
        ...
        guarda.setBackground(new java.awt.Color(13, 229, 13));
        ...
        jPanel1.add(guarda, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 470, -1, 30));
        ...
        jPanel1.add(cancela, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 470, -1, 30));
...
//            String fechaComoStr = formato.format(fecha.getText());
            ...
            VtnInicio.matriz = Manipulacion.insertaObj(VtnInicio.matriz, hi, buscaCveRHP.cv);
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VtnRegHisPer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
